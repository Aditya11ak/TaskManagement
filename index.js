...
// DOM Objects [Document Object Modelo]
        ...
        <div class="card-body">
          ${
              url
                ...
                : `<img width='100%' src="https://static.vecteezy.com/system/resources/thumbnails/025/067/762/small_2x/4k-beautiful-colorful-abstract-wallpaper-photo.jpg" alt='card image cap' class='card-img-top md-3 rounded-lg' />`
            }
...
// here e is event which we are looking for when we compare the id with the event if both matches then and then only the card details will be displayed
var openTask = (e) => {
  if (!e) e = window.event;
...
// This variable is for deleting the task
var deleteTask = (e) => {
  if (!e) e = window.event;
...
// This variable is for editing the task
var editTask = (e) => {
  if (!e) e = window.event;
...
// NOT REMOVED THE CURLY BRACES HERE IF WANT TO WRITE {} THEN THERE SHOULD BE RETURN STATEMENT HERE
